        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-sky-600">
              Twój doradca klimatyzacji na Białołęce i okolicach
            </p>

            <p className="mt-5 text-base leading-relaxed text-slate-600">
              Pomagam mieszkańcom <strong>Białołęki, Targówka, Marek i okolic</strong> w doborze i montażu klimatyzacji od podstaw. Bez stresu, bez ukrytych kosztów, bez czekania tygodniami na wycenę.
            </p>
              ...
              <ul className="mt-5 space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-600">Wideokonsultacja przez WhatsApp lub przesłanie zdjęć — pokazujesz wnętrze, dostajesz konkretną cenę tego samego dnia.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                  ...
                  <div>
                    <strong className="text-slate-900">🛠️ 20 lat doświadczenia</strong>
                    <p className="mt-0.5 text-sm text-slate-600">Wiem, jak to robić porządnie</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
